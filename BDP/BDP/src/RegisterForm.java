...
public class RegisterForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField_User.setBackground(new java.awt.Color(191, 191, 191));
        ...
        jPasswordField_Pass.setBackground(new java.awt.Color(191, 191, 191));
        ...
        jLabel8.setText("Rescrie parola:");

        jPasswordField_Pass2.setBackground(new java.awt.Color(191, 191, 191));
        jPasswordField_Pass2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jPasswordField_Pass2.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTextField_User, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jPasswordField_Pass, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(16, 16, 16)
                        .addComponent(jLabel8)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jPasswordField_Pass2, javax.swing.GroupLayout.PREFERRED_SIZE, 190, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(138, 138, 138)
    ...
    private void jButtonRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonRegisterActionPerformed
        ...
        String re_pass = String.valueOf(jPasswordField_Pass2.getPassword());
        
        if(uname.equals(""))
        {
            JOptionPane.showMessageDialog(null,"Adauga un nume de utilizator");
        }
        
        else if(pass.equals(""))
        {
            JOptionPane.showMessageDialog(null,"Adauga o parola");
        }
        else  if(!pass.equals(re_pass))
        {
            JOptionPane.showMessageDialog(null,"Rescrie parola");
        }
...
//    }
        ...
        String query = "INSERT INTO `utilizatori`(`Nume`, `Prenume`, `Utilizator`, `Parola`) VALUES (?,?,?,?)";
        try {
            ...
            {
                JOptionPane.showMessageDialog(null,"Utilizator creat");
            }
    ...
    public boolean checkUsername(String username)
    {
        ...
        String query = "SELECT * FROM `utilizatori` WHERE `Utilizator` =?";
